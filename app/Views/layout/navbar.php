    ...
    <div
      ...
      <ul class="nav-menus">
          ...
          <div class="form search-form mb-0">
            <div class="input-group">
              <span class="input-icon">
                <svg>
                  <use
                    href="<?= base_url(''); ?>riho/assets/svg/icon-sprite.svg#search-header"></use>
                </svg>
                <input class="w-100" type="search" placeholder="Search" /></span>
            </div>
          </div>
        </li>
        ...
        <li class="onhover-dropdown">
          <svg>
            <use href="<?= base_url(''); ?>riho/assets/svg/icon-sprite.svg#star"></use>
          </svg>
                            ...
                            <li class="pr-0 pl-0 pb-3 pt-3">
                              <div class="media">
                                <img
                                  ...
                                  src="<?= base_url(''); ?>riho/assets/images/other-images/receiver-img.jpg"
                                  alt="" />
                                <div class="media-body">
                                  <a
                                    class="f-light f-w-500"
                                    href="product.html">Men Blue T-Shirt</a>
                                  <div class="qty-box">
                                    <div class="input-group">
                        ...
                        <ul>
                          ...
                          <li>
                            <div class="user-alerts">
                              <img
                                class="user-image rounded-circle img-fluid me-2"
                                src="<?= base_url(''); ?>riho/assets/images/dashboard/user/6.jpg"
                                alt="user" />
                              <div class="user-name">
                                <div>
                                  <h6>
                                    <a
                                      class="f-w-500 f-14"
                                      href="user-profile.html">Dianne Russell</a>
                                  </h6>
                            ...
                            <div
                              ...
                              <div class="user-alerts flex-shrink-0">
                                <img
                                  ...
                                  src="<?= base_url(''); ?>riho/assets/images/dashboard/user/3.jpg"
                                  alt="user" />
                              </div>
                              <div class="flex-grow-1">
                                <div class="common-space user-id w-100">
                                  <div class="common-space w-100">
                                    <a
                                      class="f-w-500 f-12"
                                      href="private-chat.html">Robert D. Hambly</a>
                                  </div>
                                </div>
                                <div>
                                  <span class="f-w-500 f-light f-12">Hello Miss...😊</span>
                                </div>
                              </div>
                          ...
                          <li
                            ...
                            <div
                              ...
                              <div class="user-alerts flex-shrink-0">
                                <img
                                  class="rounded-circle img-fluid img-40"
                                  src="<?= base_url(''); ?>riho/assets/images/dashboard/user/7.jpg"
                                  alt="user" />
                              </div>
                              <div class="flex-grow-1">
                                <div class="common-space user-id w-100">
                                  <div class="common-space w-100">
                                    <a
                                      class="f-w-500 f-12"
                                      href="private-chat.html">Courtney C. Strang</a>
                                  </div>
                                </div>
                                <div>
                                  <span class="f-w-500 f-light f-12">Wishing You a Happy Birthday Dear..
                                    🥳🎊</span>
                                </div>
                              </div>
                              ...
                              <div class="flex-grow-1">
                                <div class="common-space user-id w-100">
                                  <div class="common-space w-100">
                                    <a
                                      class="f-w-500 f-12"
                                      href="private-chat.html">Raye T. Sipes</a>
                                  </div>
                                </div>
                                <div>
                                  <span class="f-w-500 f-light f-12">Hello Dear!! This Theme Is Very
                                    beautiful</span>
                                </div>
                              </div>
                              ...
                              <div class="flex-grow-1">
                                <div class="common-space user-id w-100">
                                  <div class="common-space w-100">
                                    <a
                                      class="f-w-500 f-12"
                                      href="private-chat.html">Henry S. Miller</a>
                                  </div>
                                </div>
                                <div>
                                  <span class="f-w-500 f-light f-12">You’re older today than yesterday,
                                    happy birthday!</span>
                                </div>
                              </div>
                        ...
                        <ul>
                          <li class="pr-0 pl-0 pb-3">
                            <div class="media">
                              <img
                                class="img-fluid b-r-5 me-3 img-60"
                                src="<?= base_url(''); ?>riho/assets/images/other-images/cart-img.jpg"
                                alt="" />
                              <div class="media-body">
                                <a
                                  class="f-light f-w-500"
                                  href="product.html">Furniture Chair for Home</a>
                                <div class="qty-box">
                                  <div class="input-group">
                                    <span class="input-group-prepend">
                                      <button
                          ...
                          <li class="pr-0 pl-0 pb-3 pt-3">
                            <div class="media">
                              ...
                              <div class="media-body">
                                <a
                                  class="f-light f-w-500"
                                  href="product.html">Men Cotton Blend Blue T-Shirt</a>
                                <div class="qty-box">
                                  <div class="input-group">
                                    <span class="input-group-prepend">
                                      <button
