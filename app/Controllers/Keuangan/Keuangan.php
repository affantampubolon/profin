  ...
  public function insertAnggaran()
  {
      try {
        ...
        $seq = $builder->select('seq')->get()->getRow();
          ...
          // Complete transaksi jika sukses
          $db->transComplete();
          ...
          if ($db->transStatus() === FALSE) {
              ...
              return $this->response->setJSON([
                  'status' => 'error',
                  'message' => 'Terjadi kesalahan saat menyimpan data. Transaksi dibatalkan.',
              ]);
          }
  ...
  public function insertRealisasi()
  {
      try {
          ...
          if ($db->transStatus() === FALSE) {
              ...
              return $this->response->setJSON([
                  'status' => 'error',
                  'message' => 'Terjadi kesalahan saat menyimpan data realisasi biaya. Transaksi dibatalkan.',
              ]);
          }
  ...
  public function insertDropping()
  {
      try {
        ...
        if ($db->transStatus() === FALSE) {
            ...
            return $this->response->setJSON([
                'status' => 'error',
                'message' => 'Terjadi kesalahan saat menyimpan data biaya dropping. Transaksi dibatalkan.',
            ]);
        }
      ...
      try {
        ...
        foreach ($data as $row) {
            ...
            $insertData[] = [
                ...
                'file_invoice' => $row['file_invoice'] ?? null,
                'user_create' => $username,
                'create_date' => date('Y-m-d H:i:s'),
            ];
        }
        ...
        if ($db->transStatus() === FALSE) {
            ...
            return $this->response->setJSON([
                'status' => 'error',
                'message' => 'Terjadi kesalahan saat menyimpan data pembayaran. Transaksi dibatalkan.',
            ]);
        }
